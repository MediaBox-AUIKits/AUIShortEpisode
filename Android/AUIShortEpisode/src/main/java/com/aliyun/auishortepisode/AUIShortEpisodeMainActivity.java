...
public class AUIShortEpisodeMainActivity extends AVBaseListActivity {
    ...
    public List<ListModel> createListData() {
        ...
        menu.add(new ListModel(INDEX_VIDEO_LIST_EPISODE, R.drawable.ic_player_quanping, getResources().getString(R.string.player_videolist_episode), getResources().getString(R.string.player_video_episode_msg)));
